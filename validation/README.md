...
| dashboard_spatial_ward.py | Interactive dashboard to explore various pre-computed hyperparameter combinations for spatial Ward in geographic and UMAP spaces | labels_spatial_ward.csv, internal_validation_spatial_ward.csv (from clustering experiments)                                                                      |
...
| score_evaluation.ipynb    | Explore and plot the cluster validity indexes computed for the various clustering experiments                                    | internal_validation_kmeans.csv, internal_validation_ward.csv, internal_validation_dbscan.csv, internal_validation_spatial_ward.csv (from clustering experiments) |
